...
<div class="grid place-items-center min-h-screen bg-gradient-to-t from-blue-200 to-white text-gray-900 p-5">
  <div>
    <h1 class="text-4xl sm:text-5xl md:text-7xl font-bold text-gray-200 mb-5" data-aos="fade-up">Music</h1>
    <section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div class="bg-gray-900 shadow-lg rounded p-3" data-aos="fade-up">
